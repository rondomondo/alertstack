...
var (
	someLabels = []string{
		...
		"extra_slack_recipient", "extra_slack_recipient_test",
		"instance", "arg1", "arg2",
	}
...
func (s *Server) pingHandler(w http.ResponseWriter, r *http.Request) {
	...
	params := map[string]string{
		...
		"extra_slack_recipient_test": r.URL.Query().Get("extra_slack_recipient_test"),
	...
	pingCounterPrometheus.WithLabelValues(
		...
		params["extra_slack_recipient_test"], params["instance"],
...
func main() {
	...
	flag.StringVar(&config.ServerKey, "key", "server.key", "TLS key file")
	flag.StringVar(&config.ServerCert, "cert", "server.crt", "TLS certificate file")
